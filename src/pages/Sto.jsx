  ...
  return (
    <div className="flex flex-col md:flex-row ">
     ...
     <div className=" flex justify-start gap-5 flex-wrap ">
          <div className="w-1/4">
            <p className="text-[11px] text-zinc-400 ml-6 -mb-6 relative z-10">City</p>
            <select className=" border-b-2 !active:border-none w-full p-3 m-3 ">
              {play.map(play => <option>{play}</option>)}
              
            </select>
          </div> 
          <div className="w-1/4">
            <p className=" text-[11px] text-zinc-400 ml-6 -mb-6 relative z-10 ">District</p>
            <select className="border-b-2 active:border-none w-full p-3 m-3">
          ...
          <div className="w-1/4">
            <p className="text-[11px] text-zinc-400 ml-6 -mb-6 relative z-10">Store</p>
            <select className="border-b-2 ! active:border-none w-full p-3 m-3  ">
             {stores.map(store => <option>{store}</option>)}
            </select>
          </div>
        ...
        <div className=" md:w-full w-60">
          ...
          <iframe className="w-60  md:w-full"
