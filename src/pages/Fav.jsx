  ...
  return (
    <div className="flex">
        ...
        <div className='border p-5  w-full m-8 j md:w-full'>
          ...
          { favSize === 0   &&  (<div className=" flex flex-col items-center justify-center h-80 ">
                <img src='https://dfcdn.defacto.com.tr/AssetsV2/dist/img/icon-heart.svg' alt="" />
                <p className="font-semibold">There is no product in your favorites</p>
                <div className="bg-black text-white w-[min(75%,18rem)] text-center py-3 hover:bg-white hover:text-black m-16  ">Start Shoping</div>
            </div>)}
            {favSize!==0&& fav.map(
              (valu ,index)=>(
                <ProductView/>
