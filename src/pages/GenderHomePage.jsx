...
export default function GenderHomePage({gender, genderData}) {
  ...
  return (
    <div className="flex flex-col gap-12 pt-12 dark:bg-stone-900 dark:text-white h-full">
       <div className="hidden md:inline"><ImageSlider data = {genderData["slideShow"]} /></div> 
