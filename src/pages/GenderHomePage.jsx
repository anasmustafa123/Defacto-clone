...
export default function GenderHomePage({gender, genderData}) {
  ...
  return (
    <div className="flex flex-col gap-12 pt-12">
      ...
      <Link to={query+";category:"+genderData['backToCity']['category']} className="w-full flex justify-center">
        <img
          className="w-4/5"
      ...
      <Link to={query+";category:"+genderData['backToCollege']['category']} className="flex justify-center">
        <img
          className="w-9/12"
      ...
      <Link to={query+";category:"+genderData['fasion']['category']} className="flex justify-center">
        <img
          className="w-8/12"
