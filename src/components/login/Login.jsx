...
export default function Login({ loginclose, registerBtn, setRegisterBtn }) {
  ...
  return (
    <>
      <div className=" flex flex-col items-center justify-center w-96 bg-white h-full dark:bg-stone-800 dark:text-white">
        ...
        <div className="flex text-xs h-20 bg-neutral-800 w-full">
          <span className="relative grid content-center text-white">
