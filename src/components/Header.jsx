...
export default function Header({ genderChoosed, setGenderChoosed }) {
  ...
  function LoginMenu() {
    return (
      <div className="hidden group-hover:block absolute bg-black z-50 w-64 h-48 dark:hover:bg-stone-950 dark:hover:text-white dark:bg-stone-950 ">
        <div className="p-3 dark:bg-stone-950">
          <div className="mb-3 dark:bg-stone-950">
            <button
              onClick={() => {
                logintoggle(true);
                setRegisterBtn(false);
              }}
              className="w-full bg-black text-center text-white h-11 hover:bg-white hover:text-black hover:border-neutral-800 hover:border-2 group dark:hover:bg-stone-950 dark:hover:text-white"
            >
              sign in
            </button>
          </div>
          <div className="flex mb-3 dark:hover:bg-stone-950 dark:hover:text-white">
            <div className="w-24">
              <p className="text-gray-500  text-sm font-extraligh ">
                Not a Member?
              </p>
            </div>
            <div className="flex">
  ...
  return (
    <>
      ...
      <div className="border-b-2 dark:border-none realtive w-full dark:bg-stone-950">
