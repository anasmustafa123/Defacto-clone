...
export default function ShoppingCart({carttoggle}) {
  ...
  return (
    <div className="p-3 max-w-md bg-white min-h-screen dark:bg-stone-950 dark:text-white">
      ...
      {cartSize === 0 && (
        <>
          ...
          <p className="mb-5">
            You can start shopping right away by checking the suggestions below,
            or you can discover DeFacto with the category links.
          </p>
        </>
      )}
      {/* items */}
      ...
      <div className="flex flex-col gap-4 mt-12">
        <button className=" border-2 border-gray-600 pt-3 pb-3 rounded-lg">
